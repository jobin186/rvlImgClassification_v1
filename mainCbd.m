...
%imdb.patchSize=224;
%imdb.stride =100;
imdb.feature = 'dcnn'; % {'dcnn', 'rcnn','drcnn', 'hog', 'gabor'}
imdb.expDir = ['/home/jobinkv/rvlV1/exp02/',imdb.feature]; % 9--> 1:8k,10-->1:end
opts.useGpu = true;
...
if isempty(imdb.encoder)
    ...
    for i =1:imdb.batchSize:30000 %numel(imdb.Sets{1}.imagePath)
            tic
